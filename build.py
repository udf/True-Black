...
chat_outBubbleGradient={black_10}
chat_outBubbleGradientSelectedOverlay={black_20}
...
chat_outUpCall={rgba(255, 255, 255, 255)}
...
dialogRedIcon={rgba(238, 104, 111, 222)}
dialogRoundCheckBox={rgba(62, 193, 249)}
dialogRoundCheckBoxCheck={white}
dialogScrollGlow={white_90}
dialogSearchBackground={rgba(45, 45, 45, 255)}
dialogSearchHint={rgba(127, 127, 127, 255)}
dialogSearchIcon={rgba(120, 120, 120, 255)}
dialogSearchText={rgba(255, 255, 255, 255)}
...
wallpaperFileOffset={rgba(255, 255, 255, 255)}
windowBackgroundChecked={rgba(47, 118, 171, 255)}
windowBackgroundCheckText={rgba(255, 255, 255, 255)}
